...
export const chapters = notes.chapters;

export const ui = {
  "zh-Hant": { site:"生物統計學習筆記", tag:"從概念、推導到實務判讀", chapters:"章節目錄", search:"搜尋筆記", placeholder:"輸入關鍵字，例如：t 檢定、信賴區間", hero:"用清楚的脈絡，重新理解生物統計", intro:"這裡整理統計概念、公式推導與方法選擇。內容依九個主題編排，適合循序閱讀，也可以直接查找需要的統計方法。", start:"從第一章開始", all:"瀏覽全部章節", prev:"上一章", next:"下一章", notice:"本網站由個人學習筆記整理而成，內容持續校訂中；研究與臨床決策仍應查閱正式教材及原始文獻。", pending:"翻譯準備中", readZh:"閱讀繁體中文版" },
