...
const topicSymbols: Record<string, SymbolRow[]> = {
  ...
  "one-way-anova": [["Xᵢⱼ", "第 j 組中的第 i 個觀察值"], ["X̄ⱼ、X̄··", "第 j 組平均數與全部資料的總平均數"], ["nⱼ、n、k", "第 j 組樣本數、總樣本數與組別數"], ["SSM、SSE、SST", "組間、組內與全體平方和"], ["MSM、MSE", "組間均方與組內均方"], ["F", "組間均方除以組內均方所得的 ANOVA 檢定統計量"]],
